...
public class Hashtable {
    ...
    public Object get(Object key) {
		int index = this.hash(key); // get hash value
		LinkedList<HashtableRecord> myList = (LinkedList<HashtableRecord>) this.table[index]; // create a linked list
		if (this.table[index] == null) { // if the value is null return null
			return null;
		}
		for (HashtableRecord value : myList) { // walk through the table
			if (value.key.equals(key)) { //if the keys equal each other
